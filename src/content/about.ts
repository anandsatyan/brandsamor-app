...
export const aboutSections: InfoSection[] = [
  {
    ...
    paragraphs: [
      'Brandsamor is a private-label fragrance manufacturer that helps businesses launch ready-to-sell fragrance products under their own brand. Instead of building a factory, brands work with Brandsamor to sample scents, choose product formats, customize packaging, and receive finished fragrance products with quality checks handled for them.',
