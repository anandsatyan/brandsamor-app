...
export const COMMERCIAL_TIER_OPTIONS: OptionItem[] = [
  { value: 'affordable_everyday', label: 'Affordable everyday product' },
  { value: 'accessible_premium', label: 'Accessible premium product' },
  { value: 'premium_brand_extension', label: 'Premium brand extension' },
  { value: 'luxury_limited_edition', label: 'Luxury / limited-edition product' },
  { value: 'unsure_recommend', label: "I'm not sure — recommend the best route for my brand" },
];
