...
export const SAMPLE_KIT_PRICES = {
  ...
  pln: 40000,
  czk: 230000,
  huf: 37000, // Stripe treats HUF as zero-decimal
  ron: 47000,
  bgn: 18500,
  jpy: 15000,
  krw: 135000,
  ...
  sar: 37500,
  qar: 36500,
  kwd: 31000, // 31.000 KWD
  bhd: 38000, // 38.000 BHD
  omr: 39000, // 39.000 OMR
  zar: 185000,
  brl: 55000,
  mxn: 185000,
  ars: 10000000,
  ...
  rub: 950000,
  uah: 410000,
  isk: 14000, // zero-decimal in Stripe
};

export const DEFAULT_SAMPLE_KIT_PRICE = { amount: 10000, currency: 'usd' };
...
export function getSampleKitPrice(country) {
...
export function formatSampleKitMoney(amount, currency = 'usd', locale = undefined) {
...
export function sampleKitPriceLabel(country, locale = undefined) {
